...
public class HackingVideos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hacking_videos);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position ==  0) {
                    ...
                    webView.setWebViewClient(new HackingVideos.client());
    ...
    private class client extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            // TODO Auto-generated method stub
            Toast.makeText(HackingVideos.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
