...
public class Connector extends AppCompatActivity {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (value == 0) {
                    ...
                    if (position == 0) {
                        ...
                        webView.setWebViewClient(new Connector.client());
                        webView.setWebChromeClient(new Connector.MyChrome());
    ...
    private class client extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            // TODO Auto-generated method stub
            Toast.makeText(Connector.this, "Select an app to download ", Toast.LENGTH_SHORT).show();
